...
public class ClazzServlet extends HttpServlet {
	...
	private void deleteClazz(HttpServletRequest request,
		...
		ClazzOpera clazzOpera=new ClazzOpera();
		if(clazzOpera.deleteClazz(id)){
			try {
	...
	private void getClazzList(HttpServletRequest request,HttpServletResponse response){
		...
		clazz.setName(name);
		ClazzOpera clazzOpera=new ClazzOpera();
		List<Clazz> clazzList = clazzOpera.getClazzList(clazz, new Page(currentPage,pageSize));
	    int total=clazzOpera.getClazzListTotal(clazz);
		clazzOpera.closeCon();
