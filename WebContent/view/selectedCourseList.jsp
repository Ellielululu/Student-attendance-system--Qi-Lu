...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        title:'List of Selected Courses', 
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$.messager.alert("Message notification","Course full","warning");
										return;
									}else if(msg=="courseSelected")
									{
										$.messager.alert("Message notification","Already been selected","warning");
										return;
									}else{
										
											$.messager.alert("Message notification","Internal system error","warning");
											return;
		...
		$("#add_studentList, #add_courseList").combobox({
	  		width: "200",
	  		height: "30",
	  		valueField: "id",
	  		textField: "name",
